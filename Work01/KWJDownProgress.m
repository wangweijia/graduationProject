...
#define BgWidth            300.0
#define LateralInset       12.0 //label

@interface KWJDownProgress()
...
@implementation KWJDownProgress

+(KWJDownProgress *)progressWithTitle:(NSString *)title{
    KWJDownProgress *load = [[KWJDownProgress alloc]initWithTitle:title];
    
    return load;
}

+(KWJDownProgress *)progressWithTitle:(NSString *)title ParentController:(id)object{
    KWJDownProgress *load = [[KWJDownProgress alloc]initWithTitle:title parentController:object];
...
//    [_activity startAnimating];
    ...
    CGFloat progressW = 200;
    CGFloat progressX = (BgWidth - progressW) / 2;
    CGFloat progressY = 60;
    CGFloat progressH = 0;
    progressView.frame = CGRectMake(progressX, progressY, progressW, progressH);
    progressView.hidden = NO;
    _progressView = progressView;
    [self.loadBg addSubview:progressView];
