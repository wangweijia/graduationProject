...
@interface KWJCollectCourseCell()
...
@implementation KWJCollectCourseCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    KWJCollectCourseCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[KWJCollectCourseCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
...
-(void)collectButton_Click{
    if ([self.delegates respondsToSelector:@selector(cellectButtonClick:)]) {
        _isCollect = !_isCollect;
        [self.delegates cellectButtonClick:self.course];
